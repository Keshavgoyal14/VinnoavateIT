   ...
   >
      ...
      <div id="projects" className='mt-30 md:h-screen md:mt-10'> 
        ...
        className="w-[90%] mx-auto ">
          ...
          <div className='w-full md:w-[50%] justify-center  items-center '> <img src="https://i.postimg.cc/rwdcnM7H/image.png" alt="MessIT" 
          ...
          <div className='w-full mb-10 md:mb-0 md:w-[50%] flex flex-col mr-20 items-center text-center ' ><h2 className="text-2xl md:text-4xl text-purple-300 font-bold  text-center mb-20 transition delay-150 duartion-300 ease-in-out hover:translate-y-1 hover:scale-105">MessIT</h2>
          ...
          <div className='w-full mb-10 md:mb-0 md:w-[50%] flex flex-col mr-20 items-center text-center' ><h2 className="text-2xl md:text-4xl text-purple-300 font-bold text-center mb-20 transition ease-in-out delay-150 duration-300 hover:translate-y-1 hover:scale-105">BunkBuddies</h2>
          ...
          <div className='w-full mb-10 md:mb-0 md:w-[50%] flex flex-col mr-20 items-center text-center' ><h2 className="text-2xl md:text-4xl text-purple-300 font-bold text-center mb-20 transition delay-150 duartion-300 ease-in-out hover:translate-y-1 hover:scale-105 ">VinManager</h2>
